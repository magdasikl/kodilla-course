...
//        Then
        ...
        Assert.assertEquals("[Aggreesive predictor] Buy stock of XYZ",johnShouldBuy);
...
//        When
        String stevenShouldBuy = steven.predict();
        System.out.println("Steven shoud: :) " + stevenShouldBuy);
        steven.setBuyingStrategy(new AggresivePredictor());
        stevenShouldBuy = steven.predict();
        System.out.println("Steven now should: :)okj"+ stevenShouldBuy);

//        Then
        Assert.assertEquals("[Aggreesive predictor] Buy stock of XYZ",stevenShouldBuy);
    }
}
