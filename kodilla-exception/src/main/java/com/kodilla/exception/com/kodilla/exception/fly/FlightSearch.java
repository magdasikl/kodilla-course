...
public class FlightSearch {
    ...
    public void flightWithChange (int numberOfChange, String nameDeparture, String nameArrival, LocalDate dateFly ) {
        ...
        for (Flight flight : listDeparture) {
            if (flight.getArrivalAirport().equals(nameArrival)) {
                System.out.println("Lot bezpośredni z " + flight.getDepartureAiport() + " do " + flight.getArrivalAirport());
            } else {
                ...
                for ( Flight flight1: listCh) {
                    if (flight1.getArrivalAirport().equals(nameArrival)) {
                        System.out.println("Lot z "+ flight.getDepartureAiport() + " z przesiadką " + flight.getArrivalAirport()+ " do "+ flight1.getArrivalAirport());
                    }
